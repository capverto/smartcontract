...
contract ConfigurableToken is StandardToken, Ownable {
  uint256 public icoTokens = uint256(171375000).mul(1 ether);
  uint256 public privateIcoTokens = uint256(1125000).mul(1 ether);
  uint256 public teamTokens = uint256( 25000000).mul(1 ether);
  uint256 public legalTokens = uint256(2500000).mul(1 ether);
  uint256 public marketingTokens = uint256(10000000).mul(1 ether);
  uint256 public developmentTokens = uint256(5000000).mul(1 ether);
  uint256 public partnershipsTokens = uint256( 5000000).mul(1 ether);
  uint256 public growthTokens = uint256( 30000000).mul(1 ether);
...
contract CAP is ConfigurableToken {
  string public constant name = "CAPVERTO TOKENS";
  string public constant symbol = "CAP";
  uint32 public constant decimals = 18;

  function CAP(address _newOwner) public {
